                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-desi">
                                        <table class="all-package trans-table table table-striped" id="editableTable">
                                            <thead>
                                                <tr>
                                                    <th>User Key</th>
                                                    <th>Russian</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td data-field="text">user:users.user-lists</td>

                                                    <td data-field="text">список пользователей</td>

                                                    <td data-field="text">.قوائم المستخدمين</td>

                                                    <td data-field="text">user lists</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-first-name</td>

                                                    <td data-field="text">имя пользователя</td>

                                                    <td data-field="text">اسم المستخدم الأول</td>

                                                    <td data-field="text">user first name</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-last-name</td>

                                                    <td data-field="text">фамилия пользователя</td>

                                                    <td data-field="text">اسم المستخدم الأخير</td>

                                                    <td data-field="text">user last name</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-login</td>

                                                    <td data-field="text">логин пользователя</td>

                                                    <td data-field="text">دخول المستخدم</td>

                                                    <td data-field="text">user login</td>
                                                ...
                                                <tr class="jsgrid-row">
                                                    <td data-field="text">user:users.user-add-product</td>

                                                    <td data-field="text">добавить продукт</td>

                                                    <td data-field="text">أضف المنتج</td>

                                                    <td data-field="text">add product</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-orders-list</td>

                                                    <td data-field="text">упорядоченный список</td>

                                                    <td data-field="text">قائمة الأوامر</td>

                                                    <td data-field="text">orders list</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-coupon-list</td>

                                                    <td data-field="text">список купонов</td>

                                                    <td data-field="text">قائمة القسائم</td>

                                                    <td data-field="text">coupon list</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-new-password</td>

                                                    <td data-field="text">пользователя новый пароль</td>

                                                    <td data-field="text">.مستخدم جديد كلمة مرور</td>

                                                    <td data-field="text">user new password</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-reset-password</td>

                                                    <td data-field="text">сброс пароля</td>

                                                    <td data-field="text">أعد ضبط كلمة السر</td>

                                                    <td data-field="text">user reset password</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-roles</td>

                                                    <td data-field="text">роль пользователя</td>

                                                    <td data-field="text">أدوار المستخدم</td>

                                                    <td data-field="text">user roles</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">user:users.user-profile-information</td>

                                                    <td data-field="text">информация профиля</td>

                                                    <td data-field="text">معلومات التوصيف</td>

                                                    <td data-field="text">profile information</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">admin:admin.button.delete</td>

                                                    <td data-field="text">удалить</td>

                                                    <td data-field="text">احذف</td>

                                                    <td data-field="text">delete</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">admin:admin.button.save</td>

                                                    <td data-field="text">спасать</td>

                                                    <td data-field="text">احفظ</td>

                                                    <td data-field="text">save</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">admin:admin.button.edit</td>

                                                    <td data-field="text">редактировать</td>

                                                    <td data-field="text">حرر</td>

                                                    <td data-field="text">edit</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">admin:admin.tabs.general</td>

                                                    <td data-field="text">главные вкладки</td>

                                                    <td data-field="text">الألسنة العامة</td>

                                                    <td data-field="text">general tabs</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">category:categories.physical</td>

                                                    <td data-field="text">физический</td>

                                                    <td data-field="text">جسدي</td>

                                                    <td data-field="text">physical</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">category:categories.digital</td>

                                                    <td data-field="text">цифровой</td>

                                                    <td data-field="text">رقمي</td>

                                                    <td data-field="text">digital</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">category:categories.sub.category</td>

                                                    <td data-field="text">промежуточная категория</td>

                                                    <td data-field="text">الفئة الفرعيةر</td>

                                                    <td data-field="text">sub category</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">media:media.dropzone</td>

                                                    <td data-field="text">зона сброса</td>

                                                    <td data-field="text">منطقة الإسقاط</td>

                                                    <td data-field="text">dropzone</td>
                    ...
                    <form class="needs-validation">
                        <div class="form">
                            ...
                            <div class="form-group mb-0">
                                <label for="validationCustom02" class="mb-1">Sub
