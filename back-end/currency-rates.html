                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-desi">
                                        <table class="table all-package table-category current-table "
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td data-field="text">Us Dollar</td>

                                                    <td data-field="text">2.4512478</td>

                                                    <td data-field="number">USD</td>

                                                    <td data-field="number">0.57912364</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">Afghanistan Afghani</td>

                                                    <td data-field="text">5.14761214</td>

                                                    <td data-field="number">AFN</td>

                                                    <td data-field="number">1.05761432</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">United Arab Emirates Dirham</td>

                                                    <td data-field="text">12.02646581</td>

                                                    <td data-field="number">AED</td>

                                                    <td data-field="number">0.15642465</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">European Union</td>

                                                    <td data-field="text">8.124712425</td>

                                                    <td data-field="number">EUR</td>

                                                    <td data-field="number">0.187541231</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">Japanese</td>

                                                    <td data-field="text">10.78422121</td>

                                                    <td data-field="number">JPY</td>

                                                    <td data-field="number">3.8425110221</td>
                                                ...
                                                <tr>
                                                    <td data-field="text">Great Britain Pound</td>

                                                    <td data-field="text">7.1246121152</td>

                                                    <td data-field="number">GBP</td>

                                                    <td data-field="number">0.25522648</td>
